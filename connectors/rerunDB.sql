...
INSERT INTO users (email, phone, fname, lname, password, salt, birthdate, gender, avatar) VALUES 
('bahymohamed2010@gmail.com', '1234567890', 'Bahy', 'Mohamed', 'd77c87833f8533dbd4cf82df89d54e8c9e4acaae5f0eb2aea5bd80696bfa0cf546dc3063575547eaf5e42c4e0102255b9ee4233cbf6cbe685bfd7afea7cc408e', '71cf314584466397041a690d394a2cfc', '1990-01-01', 'M', 1);

INSERT INTO traveler (id, preferences, aboutme) VALUES 
(21, ARRAY['beach', 'hiking','food','culture'], 'I have an insatiable wanderlust that draws me to sandy shores and rugged trails. There is an inexplicable joy in feeling the salty breeze on my face and the thrill of conquering new peaks.');
...
INSERT INTO posts (user_id, country, city, title, postdate, tags, images, description)
VALUES
    (21, 'Germany', 'Berlin', 'Exploring Berlin', '2023-09-01 09:30:00', ARRAY['travel', 'history', 'culture'], ARRAY['https://picsum.photos/2200/2200', 'https://picsum.photos/2500/2500', 'https://picsum.photos/2800/2800'], 'This post is all about my adventures in Berlin, a city rich in history and culture.'),
    (21, 'Greece', 'Athens', 'Greek Cuisine', '2023-09-02 12:15:00', ARRAY['food', 'culture'], ARRAY['https://picsum.photos/2300/2300', 'https://picsum.photos/2600/2600'], 'In Athens, I indulged in the exquisite Greek cuisine. Check out this post to explore the flavors of Greece.'),
    (21, 'Australia', 'Melbourne', 'Melbourne Street Art', '2023-09-03 15:45:00', ARRAY['art', 'travel'], ARRAY['https://picsum.photos/2400/2400', 'https://picsum.photos/2900/2900'], 'Discover the vibrant street art scene of Melbourne in this post, where art meets the urban landscape.'),
    (21, 'Thailand', 'Bangkok', 'Temples of Bangkok', '2023-09-04 11:20:00', ARRAY['travel', 'architecture', 'culture'], ARRAY['https://picsum.photos/2700/2700', 'https://picsum.photos/2800/2800'], 'I explored the magnificent temples of Bangkok, a journey filled with spirituality and awe-inspiring architecture.'),
    (21, 'Mexico', 'Mexico City', 'Colors of Mexico', '2023-09-05 14:10:00', ARRAY['culture', 'travel'], ARRAY['https://picsum.photos/2500/2500', 'https://picsum.photos/2100/2100', 'https://picsum.photos/2200/2200'], 'Mexico Citys vibrant colors and rich culture come alive in this post. Explore the essence of Mexico with me.');
...
INSERT INTO transactions (from_id, to_id, amount, token, status, date, type)
VALUES
  (21, 6, 100.50, 'ABC123', 'Paid', '2023-08-01', 'Book Local Guide'),
  (21, 7, 75.25, 'XYZ789', 'Paid', '2023-08-02', 'Book Local Guide');

INSERT INTO booklocalguide (transaction_id, package_id, date, status, quantity)
VALUES
  (16, 1, '2023-08-23', 'Booked', 5),
